...
// note : -- if we get value from random functions using set its okay while have less data but suppose we have more and more data so what happened it takes 5 times call to call random function to get full unique values 
//so we make sure every time we get unique values 
//in JS sort function will not work properly  eg 
// const arr = [10,20,30]
// arr.sort();
// it give -- [10,100,20]
//it give this because of string comparison //
//until u put comparative 


//  Now select the form and insert all the elements into it 

//lets take an eg of how random questions came to us -- question be like 
...
problem.forEach((obj,index)=>{
    ...
    para.textContent = `${index+1}. ${obj['question']}`;  //u can write obj.question also 
...
// Array.sort((a,b) => a-b); //it is mandatory we have to pass the call back function like this into this then it work properly
