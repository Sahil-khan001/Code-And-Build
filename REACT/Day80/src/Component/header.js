...
export default function Header(){
        ...
        <header className="bg-[#FF5200] font-sans">
            <div className="flex justify-between container mx-auto  py-8">
               ...
               <div className="font-bold text-white text-base flex gap-10 items-center">
                ...
                <a target="blank" className="border-2 rounded-xl px-3 py-4">Get the App</a>
                <a  target="blank" className="border-black-2 rounded-xl px-5 py-4 bg-black text-white">Sign in</a>
               </div>
                 </div>
    ...
    <div className="max-w-[55%] container mx-auto flex gap-10 mt-5 ">
        ...
        <a href="https://www.swiggy.com/restaurants"><img className="w-81 h-75" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/23/ec86a309-9b06-48e2-9adc-35753f06bc0a_Food3BU.png"/></a> 
